...
import { _ as attr, i as head, n as derived, r as ensure_array_like, t as attr_class, v as escape_html } from "../../chunks/server.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		derived(() => catalogs.tinhTp.filter((t) => {
		...
		derived(() => catalogs.quocTich.filter((q) => {
