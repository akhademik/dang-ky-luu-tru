...
-- Description: Khởi tạo schema Cloudflare D1 cho hệ thống Quản lý & Khai báo Lưu trú
...
CREATE TABLE IF NOT EXISTS stays (
    ...
    ly_do_chi_tiet TEXT,
    status TEXT NOT NULL DEFAULT 'READY_TO_SYNC', -- PENDING_VALIDATION, READY_TO_SYNC, SYNCED_KBTT, EXTENDED, CHECKED_OUT, CANCELLED
    ma_ho_so_kbtt TEXT,
    ghi_chu TEXT,
...
CREATE TABLE IF NOT EXISTS kbtt_logs (
    ...
    api_endpoint TEXT NOT NULL, -- API_4_NN, API_5_VN, API_12_CHECKOUT, etc.
    guest_name TEXT,
    so_giay_to TEXT,
    so_phong TEXT,
