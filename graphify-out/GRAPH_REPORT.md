...
## Summary
- 332 nodes · 671 edges · 18 communities (9 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4adf78c`
...
### Community 0 - "db.ts"
Cohesion: 0.11
Nodes (36): checkoutStay(), D1PreparedStatement, deleteStay(), extendStay(), generateId(), getAuditLogs(), getDashboardStats(), getDb() (+28 more)
...
### Community 10 - "D1DatabaseLike"
Cohesion: 0.24
Nodes (4): App, Platform, D1DatabaseLike, RemoteD1Database

### Community 11 - "catalogManager.ts"
Cohesion: 0.27
Nodes (6): LOAI_GIAY_TO_DATA, LY_DO_CU_TRU_DATA, QUOC_TICH_DATA, StandardCatalogItem, TINH_TP_DATA, CatalogItem
