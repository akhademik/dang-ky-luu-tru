...
## Summary
- 255 nodes · 463 edges · 15 communities (7 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9f00b78`
...
Cohesion: 0.08
Nodes (13): CatalogItem, CONFIG, CompletenessResult, RawOcrRow, TransformedRowResult, GoogleSheetService, TabInfo, ApiResponse (+5 more)
...
Cohesion: 0.16
Nodes (15): addNewGuest(), checkToken(), closeEditModal(), executeSyncBatch(), handleManualLogin(), openEditModal(), parseAndApplyAddress(), pushSelectedRows() (+7 more)
...
## Knowledge Gaps
- **70 isolated node(s):** `CatalogItem`, `CompletenessResult`, `TransformedRowResult`, `TabInfo`, `ApiResponse` (+65 more)
...
- **Why does `DataTransformer` connect `DataTransformer` to `syncPipeline.ts`, `CatalogManager`?**
