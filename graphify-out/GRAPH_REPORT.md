...
## Summary
- 365 nodes · 760 edges · 22 communities (12 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30833e8f`
...
### Community 0 - "db.ts"
Cohesion: 0.10
Nodes (41): autoCheckoutExpiredStays(), checkoutStay(), clearAuditLogs(), deleteAuditLog(), deleteStay(), extendStay(), generateId(), getAuditLogs() (+33 more)
...
- **Why does `DataTransformer` connect `DataTransformer` to `db.ts`, `syncPipeline.ts`, `KbttClient`, `CatalogManager`?**
...
- **Should `db.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.10240655401945725 - nodes in this community are weakly interconnected._
